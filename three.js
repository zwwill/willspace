...
THREE.extend(THREE.Quaternion.prototype, {
    ...
    setFromEuler: function(a, b) {
        ...
        this.z = c * d * h - f * g * e,
        this.w = c * 
        d * e + f * g * h) : "ZXY" === b ? (this.x = f * d * e - c * g * h,
        this.y = c * g * e + f * d * h,
        this.z = c * d * h + f * g * e,
...
THREE.extend(THREE.Vector3.prototype, {
    ...
    setEulerFromRotationMatrix: function(a, b) {
        ...
        this.y = Math.atan2(g, e)) : (this.x = Math.atan2(-k, 
        d),
        this.y = 0));
        return this
    },
    setEulerFromQuaternion: function(a, b) {
        ...
        this.z = Math.atan2(2 * (a.x * a.y + a.z * a.w), g - d + e - f)) : "ZXY" === b ? (this.x = Math.asin(c(2 * (a.x * a.w + 
        a.y * a.z))),
        ...
        this.y = Math.atan2(2 * (a.x * a.z + a.y * a.w), g + d - 
        e - f),
...
THREE.Projector = function() {
    ...
    this.projectScene = function(g, h, m, Pa) {
                    ...
                    if (void 0 !== Xa) {
                        ...
                        if (aa instanceof THREE.Face3)
                            ...
                            !0 === Y.visible || !0 === da.visible || !0 === Z.visible || !0 === ia.visible || W.isIntersectionBox(F.setFromPoints(L)))
                                ...
                                (ia.positionScreen.y - Z.positionScreen.y) - (da.positionScreen.y - Z.positionScreen.y) * (ia.positionScreen.x - Z.positionScreen.x),
                                la === THREE.DoubleSide || ta === (la === THREE.FrontSide)) {
                                    if (q === v) {
                                ...
                                continue;n.normalModel.copy(aa.normal);
        ...
        for (m = E.sprites.length; g < m; g++)
            ...
            C.scale.x = oa.scale.x * Math.abs(C.x - (B.x + h.projectionMatrix.elements[0]) / 
    ...
    computeVertexNormals: function(a) {
        ...
        if (void 0 === this.__tmpVertices) {
            ...
            for (c = this.faces.length; b < c; b++)
                d = this.faces[b],
                d instanceof THREE.Face3 ? d.vertexNormals = [new THREE.Vector3, new THREE.Vector3, new THREE.Vector3] : d instanceof THREE.Face4 && 
...
THREE.SceneLoader.prototype.parse = function(a, b, c) {
            ...
            if (void 0 === x.objects[p]) {
                ...
                if (q.type && q.type in l.hierarchyHandlerMap) {
                    ...
                    if (n = x.geometries[q.geometry]) {
                        ...
                        t.matrix.set(c[0], c[1], c[2], c[3], c[4], c[5], c[6], 
                        c[7], c[8], c[9], c[10], c[11], c[12], c[13], c[14], c[15])) : (t.position.set(g[0], g[1], g[2]),
                    ...
                    y.name = p,
                    x.lights[p] = y,
                    x.objects[p] = y) : "PerspectiveCamera" === q.type || "OrthographicCamera" === q.type ? ("PerspectiveCamera" === q.type ? r = new THREE.PerspectiveCamera(q.fov,q.aspect,q.near,q.far) : "OrthographicCamera" === 
                    q.type && (r = new THREE.OrthographicCamera(q.left,q.right,q.top,q.bottom,q.near,q.far)),
                    g = q.position,
    ...
    for (K in J.materials) {
        ...
        for (L in F.parameters)
            ...
            THREE.BackSide : THREE.FrontSide : "blending" === L ? F.parameters[L] = F.parameters[L] in THREE ? THREE[F.parameters[L]] : THREE.NormalBlending : "combine" === L ? F.parameters[L] = F.parameters[L] in THREE ? THREE[F.parameters[L]] : THREE.MultiplyOperation : "vertexColors" === L ? "face" == F.parameters[L] ? F.parameters[L] = THREE.FaceColors : F.parameters[L] && (F.parameters[L] = THREE.VertexColors) : "wrapRGB" === L && (E = F.parameters[L],
...
THREE.CanvasRenderer = function(a) {
    ...
    this.render = function(a, p) {
        ...
        function x(a, d, e, f, g, j, h, i) {
            ...
            !0 === i.wireframe ? C(aa, i.wireframeLinewidth, i.wireframeLinecap, i.wireframeLinejoin) : A(aa)) : !0 === i.wireframe ? C(i.color, i.wireframeLinewidth, 
            i.wireframeLinecap, i.wireframeLinejoin) : A(i.color)) : i instanceof THREE.MeshBasicMaterial || i instanceof THREE.MeshLambertMaterial || i instanceof THREE.MeshPhongMaterial ? null  !== i.map ? i.map.mapping instanceof THREE.UVMapping && (Xa = h.uvs[0],
                ...
                P || !1 === P.visible)) {
                    ...
                    if (H instanceof THREE.RenderableParticle) {
                        ...
                        if (-1 > K.positionScreen.z || 1 < K.positionScreen.z)
                            continue;if (-1 > L.positionScreen.z || 1 < L.positionScreen.z)
                            continue;if (-1 > 
                        U.positionScreen.z || 1 < U.positionScreen.z)
                            continue;K.positionScreen.x *= v;
                        K.positionScreen.y *= z;
                        L.positionScreen.x *= v;
                        L.positionScreen.y *= z;
                        ...
                        1 < K.positionScreen.z)
                            continue;if (-1 > L.positionScreen.z || 1 < L.positionScreen.z)
                            continue;if (-1 > U.positionScreen.z || 1 < U.positionScreen.z)
                            continue;if (-1 > fa.positionScreen.z || 1 < fa.positionScreen.z)
                            continue;K.positionScreen.x *= v;
                        K.positionScreen.y *= z;
                        L.positionScreen.x *= v;
                        L.positionScreen.y *= z;
                        ...
                        B(M, ca, qa, ha, ra, N, Ma, Na),
                        !0 === P.wireframe ? C(aa, P.wireframeLinewidth, P.wireframeLinecap, P.wireframeLinejoin) : A(aa)) : P instanceof THREE.MeshNormalMaterial ? 
                        (X = void 0,
                        ...
                        la.r = la.g = la.b = 1 - k(Bb.positionScreen.z * 
                        Bb.positionScreen.w, Wa, ab),
                        Fa = E(pa, Y, da, la),
                        y(M, ca, qa, ha, Ma, Na),
                        G(M, ca, qa, ha, Ma, Na, 0, 0, 1, 0, 0, 1, Fa),
                        y(mb, Pa, ra, N, ta, ka),
...
THREE.WebGLRenderer = function(a) {
    ...
    function i(a, b, c) {
        ...
        void 0 !== e && (j.bindBuffer(j.ELEMENT_ARRAY_BUFFER, e.buffer),
        ...
        for (var l = i; l !== b; l += n)
            ...
            h.render) {
                ...
                if (j)
                    ...
                    h = h[c];
                    if (!h)
                        continue;g && N.setBlending(h.blending, h.blendEquation, h.blendSrc, h.blendDst);
    ...
    function A(a, b, c, d, e) {
        ...
        if (f) {
            ...
            if ((d instanceof THREE.ShaderMaterial || d instanceof THREE.MeshPhongMaterial || d.envMap) && null  !== h.cameraPosition)
                ...
                j.uniform3f(h.cameraPosition, Qa.x, Qa.y, 
                Qa.z);
    ...
    function(a, b, c) {
        ...
        j.vertexAttribPointer(b.attributes.position, 
        3, j.FLOAT, !1, 0, 0));
        if (a.hasNormals) {
        ...
        if (!1 !== d.visible)
            ...
            f instanceof THREE.Mesh)
                if (d = e.attributes.index) {
                    ...
                    j.bindBuffer(j.ARRAY_BUFFER, n.buffer),
                    k(a.tangent),
                    j.vertexAttribPointer(a.tangent, m, j.FLOAT, 
                    !1, 0, 0))),
    ...
    this.renderBuffer = function(a, b, c, d, e, f) {
        if (!1 !== d.visible) {
            ...
            if (!d.morphTargets && 0 <= a.position)
                ...
                if (f.morphTargetForcedOrder.length) {
                    ...
                    for (g = f.morphTargetInfluences; h < d.numSupportedMorphTargets && h < i.length; )
                        ...
                        0 <= 
                        c["morphNormal" + h] && d.morphNormals && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[i[h]]),
                        k(c["morphNormal" + h]),
            ...
            j.drawElements(j.LINES, 
            e.__webglLineCount, j.UNSIGNED_SHORT, 0)) : (b && j.bindBuffer(j.ELEMENT_ARRAY_BUFFER, e.__webglFaceBuffer),
                    ...
                    m instanceof THREE.Geometry) {
                        if (void 0 === m.geometryGroups) {
                            ...
                            for (C = s.faces.length; x < C; x++)
                                ...
                                65535 < s.geometryGroups[E].vertices + 
                                F && (G[A].counter += 1,
                                E = G[A].hash + "_" + G[A].counter,
                                void 0 === s.geometryGroups[E] && (s.geometryGroups[E] = {
                                    faces3: [],
                            ...
                            if (sa.__inittedArrays) {
                                ...
                                if (fd) {
                                    ...
                                    for (mc = qc.length; db < mc; db++) {
                                        ...
                                        j.bufferData(j.ARRAY_BUFFER, tc[db], 
                                        Pa))
                                    }
                                }
                                if (pc.length) {
    ...
    this.setMaterialFaces = function(a) {
        ...
        da !== 
        b && (b ? j.disable(j.CULL_FACE) : j.enable(j.CULL_FACE),
        da = b);
...
THREE.GeometryUtils = {
    ...
    randomPointInFace: function(a, b, c) {
        ...
        if (a instanceof THREE.Face4) {
            ...
            a._area1 = c,
            a._area2 = g) : (c = THREE.GeometryUtils.triangleArea(d, 
            e, b),
            g = THREE.GeometryUtils.triangleArea(e, f, b));
...
THREE.KeyFrameAnimation.prototype.play = function(a, b) {
    if (!this.isPlaying) {
        ...
        for (c = 0; c < d; c++)
            ...
            f.animationCache.originalMatrix = e instanceof THREE.Bone ? e.skinMatrix : 
            e.matrix),
...
THREE.ExtrudeGeometry.prototype.addShape = function(a, b) {
    ...
    q = !0,
    m = !1,
    t = void 0 !== b.frames ? b.frames : new THREE.TubeGeometry.FrenetFrames(r,s,
    !1),
    A = new THREE.Vector3,
    I = new THREE.Vector3,
    C = new THREE.Vector3);
...
THREE.LatheGeometry = function(a, b, c, d) {
    ...
    for (h = b; g < h; g++) {
        ...
        for (m = a.length - 1; i < m; i++)
            ...
            d = k + f,
            l = b + e,
            this.faceVertexUvs[0].push([new THREE.Vector2(k,
...
THREE.PlaneGeometry = function(a, b, c, d) {
    ...
    for (a = 0; a < f; a++)
        for (b = 0; b < d; b++)
            ...
            c.normal.copy(l),
            c.vertexNormals.push(l.clone(), l.clone(), 
            l.clone(), l.clone()),
            this.faces.push(c),
...
THREE.PolyhedronGeometry = function(a, b, c, d) {
    ...
    function f(a, b, c, d) {
        ...
        i.faceVertexUvs[0].push([h(a.uv, 
        a, d), h(b.uv, b, d), h(c.uv, c, d)])) : (d -= 1,
        f(a, g(a, b), g(a, c), d),
        f(g(a, b), b, g(b, c), d),
        f(g(a, c), g(b, c), c, d),
...
THREE.DirectionalLightHelper = function(a, b) {
    ...
    this.targetSphere.properties.isGizmo = 
    !0,
...
THREE.SpotLightHelper = function(a, b) {
    ...
    this.targetSphere.properties.gizmoSubject = 
    a.target,
    this.targetSphere.properties.gizmoRoot = this.targetSphere,
    c = new THREE.LineDashedMaterial({
        color: c,
    ...
    this.update = function(m, n) {
        ...
        for (r = I.length; s < r; s++) {
            ...
            for (q = A.length; p < q; p++)
                ...
                z.render && (v = z.object,
                z = z.buffer,
                x = v.material instanceof THREE.MeshFaceMaterial ? 
                v.material.materials[0] : v.material,
    ...
    this.render = function(d, e, f, r) {
        ...
        if (q) {
            ...
            for (I = 0; I < q; I++)
                ...
                b.uniformMatrix4fv(v.modelViewMatrix, 
                !1, C._modelViewMatrix.elements),
                G[0] = 1,
                G[1] = 1),
                e = d.fog && x.fog ? A : 0,
                ...
                c.setBlending(x.blending, x.blendEquation, 
                x.blendSrc, x.blendDst),
    ...
    this.update = function(i, k) {
        ...
        for (m = p.length; l < m; l++)
            ...
            !(r instanceof THREE.ParticleSystem) || r.customDepthMaterial))
                (q = 
                r.material instanceof THREE.MeshFaceMaterial ? r.material.materials[0] : r.material) && b.setMaterialFaces(r.material),
        ...
        for (m = p.length; l < m; l++)
            n = p[l],
            r = n.object,
            r.visible && (r._modelViewMatrix.multiplyMatrices(k.matrixWorldInverse, 
            r.matrixWorld),
