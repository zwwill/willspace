...
$(document).ready(function(e) {
	...
	$("#btn_selectall").click(function(){
		...
		if(btn_selectall.attr("s_all")==0){
			//全选按钮变色
			btn_selectall.css("background-color","#0C0");	
			btn_selectall.css("border-color","#0C0");
			btn_selectall.attr("s_all",1);
			//全部按钮变状态
			$(".btn_select").css("background-color","#0C0");
			$(".btn_select").css("border-color","#0C0");
	...
	$(".btn_select_group").click(function(){
		...
		if(btn_select_group.attr("s_group")==0){
			//按钮变色
			btn_select_group.css("background-color","#0C0");	
			btn_select_group.css("border-color","#0C0");
			btn_select_group.attr("s_group",1);
			
			$("#"+sid+" .btn_select").css("background-color","#0C0");
			$("#"+sid+" .btn_select").css("border-color","#0C0");
