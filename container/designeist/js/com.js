...
*@author zhangwei
*/
function rfWin_top_block(){
	var container_W=$("#container").width();
	
	$("#top_block").css("width",container_W);
	var top_block_h=container_W/8;
	$("#top_block").css("height",top_block_h);
	$("#main_block").css("padding-top",top_block_h);
