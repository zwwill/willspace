...
function collect_listen() {
	$("#top_block2 .collect").click(function(){
...
function rfWin_big_logo(){
	...
	//广告区
	$('#top_block2 .big_logo').css('height',maxHeight);
	
	var height=$('#top_block2 .big_logo img').height();
	var width=$('#top_block2 .big_logo img').width();
	var param=clacImgZoomParam( maxWidth, maxHeight, width, height );
	$('#top_block2 .big_logo img').css("height",param.height);
	$('#top_block2 .big_logo img').css("width",param.width);
	$('#top_block2 .big_logo img').css("margin-top",param.top);
	$('#top_block2 .big_logo img').css("margin-left",param.left);
