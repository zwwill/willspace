...
class medoo
{
	...
	protected $server = 'localhost';//'localhost',SAE_MYSQL_HOST_M

	protected $username = 'jlqx';//'jlqx',SAE_MYSQL_USER

	protected $password = 'jlqx';//'jlqx',SAE_MYSQL_PASS

	// For SQLite
	protected $database_file = '';

	// Optional
	protected $port = 3306;//3306,SAE_MYSQL_PORT

	protected $charset = 'utf8';

	protected $database_name = 'jlqx';//'jlqx',SAE_MYSQL_DB
